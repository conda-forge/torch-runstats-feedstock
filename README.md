About torch-runstats-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/torch-runstats-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/torch-runstats-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add torch-runstats
# for installing globally
pixi global install torch-runstats
```
...
It is possible to list all of the versions of `torch-runstats` available on your platform:
...
```
pixi search torch-runstats --channel conda-forge
```
